...
create_pr() {
    ...
    git add "test_case_${test_case}"
    git commit -m "Third commit for: $title\n\nBREAKING CHANGE: This commit introduces a breaking change." --author="Co-Author <$(get_random_coauthor)>"
    ...
    git add "test_case_${test_case}"
    git commit -m "Fifth commit for: $title\n\nBREAKING CHANGE: This commit introduces yet another breaking change."
